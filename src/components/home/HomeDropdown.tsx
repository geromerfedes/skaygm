      ...
      <div className="dropdown-container">
        <div className="grid-container">
          <div className='first_row'>
            ...
            <DropdownComponent title="Papás y Mamás ocupados" isOpenInitially={false} description="Madres y Padres que buscan soluciones convenientes para hacer ejercicio en casa mientras cuidan de sus hijos." />
